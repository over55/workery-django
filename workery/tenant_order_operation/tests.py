...
class TestTenantOrderOperationViews(TenantTestCase):
    """
    Console:
    python manage.py test tenant_order_operation.tests
    """
    ...
    def setUp(self):
        ...
        """
        super(TestTenantOrderOperationViews, self).setUp()
    ...
    def test_completed_job_unassign_operation_page(self):
        ...
        a_url += "?return_id=financials-pending"
    ...
    # def test_job_retrieve_for_unassign_create_page(self):
    #     """
    #     TODO: FIX UNIT TESTS
    #     """
    #     job = WorkOrder.objects.all().first()
