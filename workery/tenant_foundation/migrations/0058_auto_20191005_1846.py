# Generated by Django 2.0.13 on 2019-10-05 18:46
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tenant_foundation', '0057_auto_20191003_0239'),
    ]

    operations = [
        migrations.RenameField(
            model_name='workorderinvoice',
            old_name='grand_total_currency',
            new_name='deposit_currency',
        ),
        ...
        migrations.AddField(
            ...
            field=djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=Decimal('0'), default_currency='CAD', help_text='The amount deposited.', max_digits=10, verbose_name='Invoice Deposit Amount'),
        ),
        migrations.AddField(
            model_name='workorder',
            name='invoice_deposit_amount_currency',
        ...
        migrations.AddField(
            model_name='workorderinvoice',
            name='deposit',
            field=djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=Decimal('0'), default_currency='CAD', help_text='Deposit', max_digits=10, verbose_name='Deposit'),
        ),
    ]
