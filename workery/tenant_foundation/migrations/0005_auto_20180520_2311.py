# Generated by Django 2.0.4 on 2018-05-20 23:11
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tenant_foundation', '0004_auto_20180520_2111'),
    ]

    operations = [
        migrations.RenameField(
            model_name='order',
            old_name='invoice_labour_currency',
            new_name='invoice_labour_amount_currency',
        ),
        migrations.RenameField(
            model_name='order',
            old_name='invoice_material_currency',
            new_name='invoice_material_amount_currency',
        ),
        migrations.RenameField(
            model_name='order',
            old_name='invoice_quote_currency',
            new_name='invoice_quote_amount_currency',
        ),
        migrations.RenameField(
            model_name='order',
            old_name='invoice_sub_total_currency',
            new_name='invoice_service_fee_amount_currency',
        ),
        migrations.RenameField(
            model_name='order',
            old_name='invoice_tax_currency',
            new_name='invoice_sub_total_amount_currency',
        ),
        migrations.RenameField(
            model_name='order',
            old_name='invoice_total_currency',
            new_name='invoice_tax_amount_currency',
        ),
        ...
        migrations.AddField(
            ...
            field=djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=Decimal('0'), default_currency='CAD', help_text='The amount charged for labour by the associate for this job.', max_digits=10, verbose_name='Invoice Labour Costs Amount'),
        ),
        migrations.AddField(
            model_name='order',
            name='invoice_material_amount',
            field=djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=Decimal('0'), default_currency='CAD', help_text='The amount charged for material costs by the associate for this job.', max_digits=10, verbose_name='Invoice Material Costs Amount'),
        ),
        migrations.AddField(
            model_name='order',
            name='invoice_quote_amount',
            field=djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=Decimal('0'), default_currency='CAD', help_text='The original quote made by the associate for this job.', max_digits=10, verbose_name='Invoice Original Quote Amount'),
        ),
        migrations.AddField(
            model_name='order',
            name='invoice_service_fee_amount',
            field=djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=Decimal('0'), default_currency='CAD', help_text='The total amount charged by the associate for this job.', max_digits=10, verbose_name='Invoice Service Fee Amount'),
        ),
        migrations.AddField(
            model_name='order',
            name='invoice_sub_total_amount',
            field=djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=Decimal('0'), default_currency='CAD', help_text='The total amount charged by the associate for this job.', max_digits=10, verbose_name='Invoice Sub-Total Amount'),
        ),
        migrations.AddField(
            model_name='order',
            name='invoice_tax_amount',
            field=djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=Decimal('0'), default_currency='CAD', help_text='The amount charged for taxes by the associate for this job.', max_digits=10, verbose_name='Invoice Tax Amount'),
        ),
        migrations.AddField(
            model_name='order',
            name='invoice_total_amount',
            field=djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=Decimal('0'), default_currency='CAD', help_text='The total amount charged by the associate for this job.', max_digits=10, verbose_name='Invoice Total Amount'),
        ),
        migrations.AddField(
            model_name='order',
            name='invoice_total_amount_currency',
