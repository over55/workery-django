    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.CharField(blank=True, db_index=True, help_text='The searchable content text used by the keyword searcher function.', max_length=1023, null=True, unique=True, verbose_name='Text')),
                ('type_of', models.PositiveSmallIntegerField(choices=[(1, 'Customer'), (2, 'Associate'), (3, 'Staff'), (4, 'Job'), (5, 'Partner'), (6, 'File')], db_index=True, help_text='The type of item this is.', verbose_name='Type of')),
