# Generated by Django 2.0.13 on 2019-10-09 16:02
...
import tenant_foundation.models.work_order_deposit
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('tenant_foundation', '0061_auto_20191009_0513'),
    ]

    operations = [
        migrations.CreateModel(
            name='WorkOrderDeposit',
            fields=[
                ('id', models.BigAutoField(db_index=True, default=tenant_foundation.models.work_order_deposit.increment_order_deposit_id_number, editable=False, primary_key=True, serialize=False)),
                ('paid_at', models.DateField(blank=True, help_text='The date this deposit was paid.', null=True, verbose_name='Paid at')),
                ('deposit_method', models.PositiveSmallIntegerField(choices=[(1, 'Cash'), (2, 'Cheque'), (3, 'Credit'), (4, 'Debit')], help_text='The method used for this deposit', verbose_name='Deposit Method')),
                ('paid_to', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'Paid to associate'), (2, 'Paid to organization.')], help_text='Whom was paid by the client for this invoice.', null=True, verbose_name='Paid to')),
                ...
                ('amount', djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=Decimal('0'), default_currency='CAD', help_text='The amount that was deposited.', max_digits=10, verbose_name='Amount')),
                ('paid_for', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'Labout'), (2, 'Materials'), (3, 'Waste Removal')], help_text='What was this deposit for?', verbose_name='Paid for')),
                ('is_archived', models.BooleanField(db_index=True, default=False, help_text='Indicates whether deposit was archived.', verbose_name='Is Archived')),
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('last_modified_at', models.DateTimeField(auto_now=True)),
                ('created_by', models.ForeignKey(blank=True, help_text='The user whom created this order.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_work_order_deposits', to=settings.AUTH_USER_MODEL)),
                ('last_modified_by', models.ForeignKey(blank=True, help_text='The user whom last modified this order.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='last_modified_work_order_deposits', to=settings.AUTH_USER_MODEL)),
                ('order', models.ForeignKey(help_text='The order whom this deposit belongs to.', on_delete=django.db.models.deletion.CASCADE, related_name='work_order_deposits', to='tenant_foundation.WorkOrder')),
            ],
            options={
                'verbose_name': 'Work Order Deposit',
                'verbose_name_plural': 'Work Order Deposits',
                'db_table': 'workery_work_order_deposits',
                'permissions': (('can_get_order_deposits', 'Can get work order deposits'), ('can_get_order_deposit', 'Can get work order deposit'), ('can_post_order_deposit', 'Can create work order deposit'), ('can_put_order_deposit', 'Can update work order deposit'), ('can_delete_order_deposit', 'Can delete work order deposit')),
                'default_permissions': (),
            },
        ),
    ]
