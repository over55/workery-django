# Generated by Django 2.0.4 on 2018-05-21 22:26
...
import tenant_foundation.models.order_service_fee
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(blank=True, default=tenant_foundation.models.order.get_todays_date, help_text='The date that this order will begin.', verbose_name='Start Date')),
                ...
                ('is_archived', models.BooleanField(db_index=True, default=False, help_text='Indicates whether order was archived.', verbose_name='Is Archived')),
                ...
                ('invoice_id', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'Residential Job Type'), (2, 'Commercial Job Type'), (3, 'Unassigned Job Type')], default=3, help_text='The type of job this is.', verbose_name='Type Of')),
                ...
                ('created', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('last_modified', models.DateTimeField(auto_now=True)),
                ('activity_sheet', models.ManyToManyField(blank=True, help_text='The activity sheet items related to the associates who accepted or rejected this order.', related_name='tenant_foundation_order_activity_sheet_items_related', through='tenant_foundation.ActivitySheetItem', to='tenant_foundation.Associate')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(db_index=True, default=tenant_foundation.models.order_service_fee.increment_order_service_fee_id_number, editable=False, primary_key=True, serialize=False)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('last_modified_at', models.DateTimeField(auto_now=True)),
                ('created_by', models.ForeignKey(blank=True, help_text='The user whom created this order.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tenant_foundation_orderservicefee_created_by_related', to=settings.AUTH_USER_MODEL)),
                ('last_modified_by', models.ForeignKey(blank=True, help_text='The user whom last modified this order.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tenant_foundation_orderservicefee_last_modified_by_related', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'OrderServiceFee',
                'verbose_name_plural': 'OrderServiceFees',
                'db_table': 'workery_order_service_fees',
                'ordering': ['percentage'],
                'permissions': (('can_get_order_service_fees', 'Can get order_service_fees'), ('can_get_order_service_fee', 'Can get order_service_fee'), ('can_post_order_service_fee', 'Can create order_service_fee'), ('can_put_order_service_fee', 'Can update order_service_fee'), ('can_delete_order_service_fee', 'Can delete order_service_fee')),
                'default_permissions': (),
            },
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='order',
            name='created_by',
            field=models.ForeignKey(blank=True, help_text='The user whom created this order.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tenant_foundation_order_created_by_related', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='order',
            name='customer',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='The service fee applied by the franchise on the total cost of this job order which will be paid by the associate member.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tenant_foundation_order_service_fee_related', to='tenant_foundation.OrderServiceFee'),
        ),
        migrations.AddField(
            model_name='order',
            name='last_modified_by',
            field=models.ForeignKey(blank=True, help_text='The user whom last modified this order.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tenant_foundation_order_last_modified_by_related', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='order',
        ...
        migrations.AddField(
            model_name='activitysheetitem',
            name='job',
            field=models.ForeignKey(help_text='The job associated with thie activity sheet item.', on_delete=django.db.models.deletion.CASCADE, related_name='tenant_foundation_activitysheetitem_jobs_related', to='tenant_foundation.Order'),
        ),
    ]
