...
urlpatterns = (
    # Summary
    path('members/summary/', list_view.MemberSummaryView.as_view(), name='workery_tenant_member_summary'),

    # Create
    path('members/create/confirm', create_view.MemberConfirmCreateView.as_view(), name='workery_tenant_member_confirm_create'),
    path('members/create/', create_view.MemberCreateView.as_view(), name='workery_tenant_member_create'),

    # List
    path('members/list/', list_view.MemberListView.as_view(), name='workery_tenant_member_list'),

    # Search
    path('members/search/', search_view.MemberSearchView.as_view(), name='workery_tenant_member_search'),
    path('members/search/results/', search_view.MemberSearchResultView.as_view(), name='workery_tenant_member_search_results'),

    # Retrieve
    path('members/<str:template>/detail/<int:pk>/lite/', retrieve_view.MemberLiteRetrieveView.as_view(), name='workery_tenant_member_lite_retrieve'),
    path('members/<str:template>/detail/<int:pk>/full/', retrieve_view.MemberFullRetrieveView.as_view(), name='workery_tenant_member_full_retrieve'),
