...
urlpatterns = (
    ...
    path('ongoing-jobs/detail/<int:pk>/operation/creation-wizard', views.OngoingWorkOrderCreationWizardOperationView.as_view(), name='workery_tenant_ongoing_job_creation_wizard_operation')
)
