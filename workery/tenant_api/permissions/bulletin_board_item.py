...
class CanListCreateBulletinBoardItemPermission(permissions.BasePermission):
...
class CanRetrieveUpdateDestroyBulletinBoardItemPermission(permissions.BasePermission):
    message = _('You do not have permission to access this API-endpoint.')
