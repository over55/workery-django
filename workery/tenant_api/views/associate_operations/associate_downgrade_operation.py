...
from tenant_api.serializers.associate_operations import AssociateDowngradeOperationSerializer
...
class AssociateDowngradeOperationAPIView(generics.CreateAPIView):
    serializer_class = AssociateDowngradeOperationSerializer
    permission_classes = (
    ...
    def post(self, request, format=None):
        ...
        write_serializer = AssociateDowngradeOperationSerializer(data=request.data, context={
