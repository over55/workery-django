...
from tenant_api.serializers.associate_operations import AssociateArchiveOperationCreateSerializer
from tenant_api.serializers.associate import AssociateRetrieveUpdateDestroySerializer


class AssociateArchiveOperationCreateAPIView(generics.CreateAPIView):
    serializer_class = AssociateArchiveOperationCreateSerializer
    permission_classes = (
    ...
    def post(self, request, format=None):
        ...
        write_serializer = AssociateArchiveOperationCreateSerializer(data=request.data, context={
            'user': request.user,
            'from_ip': client_ip,
