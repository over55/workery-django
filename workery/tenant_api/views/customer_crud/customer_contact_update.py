...
from tenant_api.serializers.customer_crud import CustomerRetrieveUpdateDestroySerializer, CustomerContactUpdateSerializer
...
class CustomerContactUpdateAPIView(generics.UpdateAPIView):
    ...
    def put(self, request, pk=None):
        ...
        write_serializer = CustomerContactUpdateSerializer(customer, data=request.data, context={
