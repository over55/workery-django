...
from tenant_api.serializers.customer_crud import CustomerRetrieveUpdateDestroySerializer, CustomerMetricsUpdateSerializer
from tenant_foundation.models import Customer


class CustomerMetricsUpdateAPIView(generics.UpdateAPIView):
    permission_classes = (
    ...
    def put(self, request, pk=None):
        ...
        write_serializer = CustomerMetricsUpdateSerializer(customer, data=request.data, context={
