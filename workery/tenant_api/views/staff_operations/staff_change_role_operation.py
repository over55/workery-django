...
from tenant_api.serializers.staff_operations import StaffChangeRoleOperationSerializer
from tenant_api.serializers.staff_crud import StaffRetrieveSerializer
from tenant_foundation.models import Staff


class StaffChangeRoleOperationAPIView(generics.UpdateAPIView):
    serializer_class = StaffChangeRoleOperationSerializer
    ...
    def put(self, request, pk=None):
        ...
        write_serializer = StaffChangeRoleOperationSerializer(staff, data=request.data, context={
