...
from tenant_api.serializers.associate_crud import AssociateAccountUpdateSerializer
...
class AssociateAccountUpdateAPIView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def put(self, request, pk=None):
        ...
        write_serializer = AssociateAccountUpdateSerializer(associate, data=request.data, context={
