...
from tenant_api.serializers.associate_crud import AssociateAddressUpdateSerializer
...
class AssociateAddressUpdateAPIView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def put(self, request, pk=None):
        ...
        write_serializer = AssociateAddressUpdateSerializer(associate, data=request.data, context={
