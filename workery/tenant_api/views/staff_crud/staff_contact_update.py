...
from tenant_api.serializers.staff_crud import StaffContactUpdateSerializer
from tenant_api.serializers.staff import StaffRetrieveUpdateDestroySerializer
from tenant_foundation.models import Staff


class StaffContactUpdateAPIView(generics.UpdateAPIView):
    serializer_class = StaffContactUpdateSerializer
    ...
    def put(self, request, pk=None):
        ...
        write_serializer = StaffContactUpdateSerializer(staff, data=request.data, context={
