...
from tenant_api.serializers.staff_crud import StaffMetricsUpdateSerializer
from tenant_api.serializers.staff import StaffRetrieveUpdateDestroySerializer
from tenant_foundation.models import Staff


class StaffMetricsUpdateAPIView(generics.UpdateAPIView):
    serializer_class = StaffMetricsUpdateSerializer
    ...
    def put(self, request, pk=None):
        ...
        write_serializer = StaffMetricsUpdateSerializer(staff, data=request.data, context={
