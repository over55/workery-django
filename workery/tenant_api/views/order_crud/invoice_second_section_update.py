...
class WorkOrderInvoiceSecondSectionUpdateAPIView(generics.UpdateAPIView):
    permission_classes = (
    ...
    def put(self, request, pk=None):
        ...
        write_serializer = WorkOrderInvoiceSecondSectionUpdateSerializer(invoice, data=request.data, context={
