...
from tenant_api.serializers.order_crud import WorkOrderInvoiceFirstSectionUpdateSerializer
...
class WorkOrderInvoiceFirstSectionUpdateAPIView(generics.UpdateAPIView):
    permission_classes = (
    ...
    def put(self, request, pk=None):
        ...
        write_serializer = WorkOrderInvoiceFirstSectionUpdateSerializer(invoice, data=request.data, context={
