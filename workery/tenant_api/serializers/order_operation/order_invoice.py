...
class WorkOrderInvoiceCreateOrUpdateOperationSerializer(serializers.Serializer):
    ...
    line02_desc = serializers.CharField(required=False, write_only=True,)
    ...
    line03_desc = serializers.CharField(required=False, write_only=True,)
    ...
    line04_desc = serializers.CharField(required=False, write_only=True,)
    ...
    line05_desc = serializers.CharField(required=False, write_only=True,)
    ...
    line06_desc = serializers.CharField(required=False, write_only=True,)
    ...
    line07_desc = serializers.CharField(required=False, write_only=True,)
    ...
    line08_desc = serializers.CharField(required=False, write_only=True,)
    ...
    line09_desc = serializers.CharField(required=False, write_only=True,)
    ...
    line10_desc = serializers.CharField(required=False, write_only=True,)
    ...
    line11_desc = serializers.CharField(required=False, write_only=True,)
    ...
    line12_desc = serializers.CharField(required=False, write_only=True,)
    ...
    line13_desc = serializers.CharField(required=False, write_only=True,)
    ...
    line14_desc = serializers.CharField(required=False, write_only=True,)
    ...
    line15_desc = serializers.CharField(required=False, write_only=True,)
    ...
    def create(self, validated_data):
        ...
        invoice, was_created = WorkOrderInvoice.objects.update_or_create(
            ...
            defaults={
                ...
                'line_02_desc': validated_data.get('line02_desc', None),
                ...
                'line_03_desc': validated_data.get('line03_desc', None),
                ...
                'line_04_desc': validated_data.get('line04_desc', None),
                ...
                'line_05_desc': validated_data.get('line05_desc', None),
                ...
                'line_06_desc': validated_data.get('line06_desc', None),
                ...
                'line_07_desc': validated_data.get('line07_desc', None),
                ...
                'line_08_desc': validated_data.get('line08_desc', None),
                ...
                'line_09_desc': validated_data.get('line09_desc', None),
                ...
                'line_10_desc': validated_data.get('line10_desc', None),
                ...
                'line_11_desc': validated_data.get('line11_desc', None),
                ...
                'line_12_desc': validated_data.get('line12_desc', None),
                ...
                'line_13_desc': validated_data.get('line13_desc', None),
                ...
                'line_14_desc': validated_data.get('line14_desc', None),
                ...
                'line_15_desc': validated_data.get('line15_desc', None),
