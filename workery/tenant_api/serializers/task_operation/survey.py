...
class SurveyTaskOperationSerializer(serializers.Serializer):
    ...
    no_survey_conducted_reason = serializers.IntegerField(required=False, allow_null=True,)
    no_survey_conducted_reason_other = serializers.CharField(required=False, allow_blank=True, allow_null=True,)
