...
class PartnerRetrieveView(DetailView, ExtraRequestProcessingMixin):
    context_object_name = 'partner'
    model = Partner
    template_name = 'tenant_partner/retrieve/view.html'
...
class PartnerCommentsRetrieveView(DetailView, ExtraRequestProcessingMixin):
    context_object_name = 'partner'
    model = Partner
    template_name = 'tenant_partner/retrieve/comments_view.html'
