...
class TestPopulateTenantSampleDBManagementCommand(TenantTestCase):
    """
    Console:
    python manage.py test tenant_foundation.tests.commands.test_populate_tenant_sample_db
    """
    #------------------#
    # Setup Unit Tests #
    #------------------#
    ...
    def setUp(self):
        super(TestPopulateTenantSampleDBManagementCommand, self).setUp()
    ...
    def tearDown(self):
        ...
        #     user.delete()
        del self.c
        super(TestPopulateTenantSampleDBManagementCommand, self).tearDown()

    def test_command_with_success(self):
        call_command(
           'populate_tenant_sample_db',
           TEST_SCHEMA_NAME,
           verbosity=0
        )
