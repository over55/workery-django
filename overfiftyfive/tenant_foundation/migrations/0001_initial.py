# Generated by Django 2.0.4 on 2018-04-12 00:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birthdate', models.DateField(blank=True, help_text='The associates birthdate.', null=True, verbose_name='Birthdate')),
        ...
        migrations.CreateModel(
            name='OrganizationCustomerAffiliation',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_of', models.PositiveSmallIntegerField(choices=[(1, 'Affiliation'), (2, 'Alumni Of'), (3, 'Funder'), (4, 'Member Of'), (5, 'Sponsor'), (6, 'Owns'), (7, 'Founder'), (8, 'Employee')], help_text='The type of affilication this customer has with the organization.', verbose_name='Type Of')),
                ('customer', models.ForeignKey(help_text='The customer of our reference.', on_delete=django.db.models.deletion.CASCADE, related_name='tenant_foundation_organizationcustomeraffiliation_customer_related', to='tenant_foundation.Customer')),
                ('organization', models.ForeignKey(help_text='The organization whom this customer is affiliated with.', on_delete=django.db.models.deletion.CASCADE, related_name='tenant_foundation_organizationcustomeraffiliation_organization_related', to='tenant_foundation.Organization')),
            ],
            options={
                'verbose_name': 'Organization Customer Affiliation',
                'verbose_name_plural': 'Organization Customer Affiliation',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birthdate', models.DateField(blank=True, help_text='The staff members birthdate.', null=True, verbose_name='Birthdate')),
                ...
                ('join_date', models.DateField(blank=True, help_text='The date the staff member joined this organization.', null=True, verbose_name='Join Date')),
                ('nationality', models.CharField(blank=True, help_text='Nationality of the person.', max_length=63, null=True, verbose_name='Nationality')),
                ('gender', models.CharField(blank=True, help_text='Gender of the person. While Male and Female may be used, text strings are also acceptable for people who do not identify as a binary gender.', max_length=63, null=True, verbose_name='Gender')),
        ...
        migrations.AddField(
            model_name='customer',
            name='organizations',
            field=models.ManyToManyField(blank=True, help_text='The organizations that this customer is affiliated with.', through='tenant_foundation.OrganizationCustomerAffiliation', to='tenant_foundation.Organization'),
        ),
        migrations.AddField(
            model_name='customer',
            name='owner',
