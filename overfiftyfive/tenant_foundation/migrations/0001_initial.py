# Generated by Django 2.0 on 2018-01-29 02:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, help_text='Email address.', max_length=254, null=True, validators=[django.core.validators.EmailValidator(message='Invalid email')], verbose_name='Email')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(blank=True, help_text='The user whom owns this comment.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tenant_foundation_comment_owner_related', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='order',
            name='created_by',
            field=models.ForeignKey(help_text='The user whom created this order.', on_delete=django.db.models.deletion.CASCADE, related_name='tenant_foundation_order_created_by_related', to='shared_foundation.O55User'),
        ),
        migrations.AddField(
            model_name='order',
            name='customer',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(help_text='The user whom last modified this order.', on_delete=django.db.models.deletion.CASCADE, related_name='tenant_foundation_order_last_modified_by_related', to='shared_foundation.O55User'),
        ),
        migrations.AddField(
