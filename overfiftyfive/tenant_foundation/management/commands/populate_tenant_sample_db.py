...
class Command(BaseCommand):
    ...
    def begin_importing_for_franchise(self, franchise):
        user1 = self.create_user(
            ...
            first_name="Bart",
            last_name="Mika",
            email="bart+executive@overfiftyfive.com",
            is_active=True,
            is_superuser=True,
            is_staff=True,
        ...
        user2 = self.create_user(
            ...
            last_name="Mika",
            email="bart+manager@overfiftyfive.com",
            is_active=True,
            is_superuser=True,
            is_staff=True,
            password=TEST_SAMPLE_USER_PASSWORD,
        ...
        user3 = self.create_user(
            ...
            first_name="Frank",
            last_name="Herbert",
            email="fherbert@overfiftyfive.com",
            is_active=True,
            is_superuser=True,
            is_staff=True,
            password=TEST_SAMPLE_USER_PASSWORD,
        ...
        user4 = self.create_user(
            ...
            first_name="Rei",
            last_name="Ayanami",
            email="rayanami@overfiftyfive.com",
            is_active=True,
            is_superuser=True,
            is_staff=True,
            password=TEST_SAMPLE_USER_PASSWORD,
        ...
        user5 = self.create_user(
            ...
            first_name="Shinji",
            last_name="Ikari",
            email="sikari@overfiftyfive.com",
            is_active=True,
            is_superuser=True,
            is_staff=True,
            password=TEST_SAMPLE_USER_PASSWORD,
