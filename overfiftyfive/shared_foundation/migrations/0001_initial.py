# Generated by Django 2.0 on 2017-12-26 18:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tel_num', models.CharField(blank=True, help_text="The telephone number of this person's profile.", max_length=16, null=True, verbose_name='Telephone Number')),
                ('tel_ext_num', models.CharField(blank=True, help_text="The telephone extension number of this person's profile.", max_length=7, null=True, verbose_name='Telephone Extension Number')),
                ('cell_num', models.CharField(blank=True, help_text="The cell number of this person's profile.", max_length=16, null=True, verbose_name='Cell Number')),
                ('created', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('last_modified', models.DateTimeField(auto_now=True, db_index=True)),
