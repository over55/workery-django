    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('franchise', models.ForeignKey(blank=True, help_text='The franchise whom this profile belongs to.', null=True, on_delete=django.db.models.deletion.CASCADE, to='shared_foundation.SharedFranchise')),
                ('user', models.OneToOneField(blank=True, help_text='The user whom is owns this profile.', null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Me',
