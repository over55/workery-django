...
from tenant_api.serializers.task_activity_sheet_item import (
    TaskActivitySheetItemCreateSerializer,
)
from tenant_foundation.models import ActivitySheetItem


class ActivitySheetItemCreateAPIView(generics.CreateAPIView):
    serializer_class = TaskActivitySheetItemCreateSerializer
    permission_classes = (
    ...
    def post(self, request, format=None):
        ...
        Create
        """
        serializer = TaskActivitySheetItemCreateSerializer(data=request.data, context={
            'user': request.user,
