...
"""
Console:
python manage.py test tenant_api.tests.test_skill_sets
"""


class SkillSetListCreateAPIViewWithTenantTestCase(APITestCase, TenantTestCase):
    ...
    def tearDown(self):
        ...
        super(SkillSetListCreateAPIViewWithTenantTestCase, self).tearDown()
