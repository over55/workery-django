...
urlpatterns = (
    ...
    # Retrieve
    path('jobs/<str:template>/detail/<int:pk>/lite/', retrieve_view.JobLiteRetrieveView.as_view(), name='o55_tenant_job_retrieve'),
    ...
    path('jobs/<str:template>/detail/<int:pk>/unassign/', retrieve_view.JobRetrieveForUnassignCreateView.as_view(), name='o55_tenant_job_retrieve_for_unassign_create'),
