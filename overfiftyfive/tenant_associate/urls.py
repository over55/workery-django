...
urlpatterns = (
    ...
    # Retrieve
    path('members/<str:template>/lite-detail/<int:pk>/', retrieve_view.MemberLiteRetrieveView.as_view(), name='o55_tenant_member_lite_retrieve'),
    path('members/<str:template>/full-detail/<int:pk>/', retrieve_view.MemberFullRetrieveView.as_view(), name='o55_tenant_member_full_retrieve'),
    path('members/<str:template>/comments/<int:pk>/', retrieve_view.MemberRetrieveForCommentsListAndCreateView.as_view(), name='o55_tenant_member_retrieve_for_comment_list'),
    path('members/<str:template>/activity-sheets/<int:pk>/', retrieve_view.MemberRetrieveForActivitySheetListView.as_view(), name='o55_tenant_member_retrieve_for_activity_sheet_list'),
